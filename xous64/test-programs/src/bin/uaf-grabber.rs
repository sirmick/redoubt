...
pub extern "C" fn _start() -> ! {
    ...
    xous::send_message(cid, Message::new_blocking_scalar(SYNC, 0, 0, 0, 0)).expect("sync failed");
    ...
    xous::send_message(cid, Message::new_blocking_scalar(CHECK, 0, 0, 0, 0)).expect("check failed");
    test_programs::park()
}
