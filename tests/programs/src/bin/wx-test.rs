...
fn map(flags: MemoryFlags) -> Result<redoubt_abi::Result, redoubt_abi::Error> {
    redoubt_abi::rsyscall(SysCall::MapMemory(None, None, redoubt_abi::MemorySize::new(4096).unwrap(), flags))
}
...
pub extern "C" fn _start() -> ! {
    ...
    let result = redoubt_abi::update_memory_flags(page, MemoryFlags::R | MemoryFlags::X);
