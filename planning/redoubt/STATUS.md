...
| 2 `unsafe` budget | (enforced) Every `unsafe` in the kernel, loader and `paging` has a SAFETY justification (0 undocumented; 211 undocumented at the fork). Budgets: `paging` 12, loader 17, SBI/PLIC/timer backends 15, RISC-V arch 10, kernel core 23. Totals only fall. |
