...
//! (planning/redoubt/NAMESPACES.md). Images this crate writes mount in the C reference and the
...
//!   `redoubt/littlefs`: `cargo fuzz run -s none image fuzz/corpus/image fuzz/seeds/image`
