...
//!
//! See `planning/redoubt/VERIFIED-BOOT.md`. A Redoubt signature never covers bare bytes a caller
...
//! (today `redoubt/testbench`'s bundle builder), which writes the preamble and then the archive.
