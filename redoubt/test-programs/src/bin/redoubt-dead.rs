...
//!
//! See `redoubt/tests/redoubt-dead.toml`.
...
pub extern "C" fn _start() -> ! {
    ...
    xous::create_thread_1(short_lived, 0).expect("the short-lived server");
    let page = rd::page();
    rd::poke(page, 0xD00D);
    ...
    xous::create_thread_1(second_server, 0).expect("the second server");
