...
//!
//! See `redoubt/tests/redoubt-revoke.toml`.
...
pub extern "C" fn _start() -> ! {
    ...
    xous::create_thread_1(server, 0).expect("the server thread");
    xous::create_thread_1(queued_caller, 0).expect("the queued caller");
    xous::create_thread_1(taken_caller, 0).expect("the taken caller");
    xous::create_thread_1(carrier, 0).expect("the carrier");
