...
one and switching between the two rebuilds neither. By hand:
    ...
    cargo build --profile checked --target riscv64imac-unknown-none-elf -p redoubt-kernel --features qemu-virt
...
ship. Add one with
    ...
    ssh-keygen -t ed25519 -N "" -C "NOT-FOR-PRODUCTION redoubt test key NAME" -f tests/keys/NAME
