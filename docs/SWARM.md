...
| K5a | building | wp-k5a | Parked 2026-09-24 at WIP deb1f534c: call surface only (redoubt-sys, model entry), no kernel code, tests or review; `map_fixed` (answer 172) for R2's stub, integrated on its own |
...
| R2 | building | wp-r2 | Parked 2026-09-24 at WIP 4f58c848c: host side built, review round 1 BLOCK (red team P1s: rt heap statics in the stub, image not unmapped, validate overflow), fix round 1 not reported; stub moves to 0x1FF0_0000; on-target mapping needs K5a (answer 172). R1b and K4 lifecycle integrated; production handoff completes K4 bundle-readback acceptance |
