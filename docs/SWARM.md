...
| G1 | ready | | Next: reconcile retained T1c/IPC review evidence and missing budget-record reviews; settle/apply Q166 before affected K5 work; BUILD-PLAN Order owns deliverables |
| K5 | waiting | | K2 merged; affected scheduling contract awaits Q166; sole kernel writer after review debt is cleared |
