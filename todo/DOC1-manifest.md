...
- A-266, A-267: native.md `redoubt-rt`; ipc.md R4 (resolved). A-268: ipc.md R13; abi.md records. A-269: testbench unsafe budget. A-270: serving.md replies and rollback. A-271: todo/mmio-record-frames.md; abi.md records, Residual (+S; the record check does not confirm a frame is RAM). A-272: todo/consoled-unknown-request-handles.md; consoled.md Residual.
